...
class ValuesTraitTest extends \PHPUnit_Framework_TestCase
{
    public function testShouldAllowSetValuesAndGetPreviouslySet()
    {
        ...
        $this->assertSame($values, \Makasim\Values\get_values($obj));
        $this->assertSame([], \Makasim\Values\get_changed_values($obj));
    }
    ...
    public function testShouldAllowSetValueAndGetPreviouslySet()
    {
        ...
        $this->assertSame(['aNamespace' => ['aKey' => 'aVal']], \Makasim\Values\get_values($obj));
        $this->assertSame(['aNamespace' => ['aKey' => 'aVal']], \Makasim\Values\get_changed_values($obj));
    }
    ...
    public function testShouldAllowSetSelfValueAndGetPreviouslySet()
    {
        ...
        $this->assertSame(['self' => ['aKey' => 'aVal']], \Makasim\Values\get_values($obj));
        $this->assertSame(['self' => ['aKey' => 'aVal']], \Makasim\Values\get_changed_values($obj));
    }
    ...
    public function testShouldAllowUnsetPreviouslySetValue()
    {
        ...
        $this->assertSame(['aName' => ['aKey' => 'aVal']], \Makasim\Values\get_values($obj));
        $this->assertSame(['aName' => ['aKey' => 'aVal']], \Makasim\Values\get_changed_values($obj));
        ...
        $this->assertSame(['aName' => ['aKey' => null]], \Makasim\Values\get_changed_values($obj));
    }
    ...
    public function testShouldAllowAddDateValueToArrayAndConvertToISO()
    {
        ...
        $this->assertSame(['aNamespace' => ['aKey' => [['unix' => $timestamp, 'iso' => $iso]]]], \Makasim\Values\get_values($obj));
        $this->assertSame(['aNamespace' => ['aKey' => [['unix' => $timestamp, 'iso' => $iso]]]], \Makasim\Values\get_changed_values($obj));
    }
    ...
    public function testShouldNotReflectChangesOnClonedObject()
    {
        ...
        $clonedObj = \Makasim\Values\clone_object($obj);
